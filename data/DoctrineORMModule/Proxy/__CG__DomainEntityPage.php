 ...
 */
class Page extends \Domain\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Domain\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'Domain\\Entity\\Page' . "\0" . 'chapter', '' . "\0" . 'Domain\\Entity\\Page' . "\0" . 'content');
        }
