 ...
 */
class Quiz extends \Domain\Entity\Quiz implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Domain\\Entity\\Quiz' . "\0" . 'id', '' . "\0" . 'Domain\\Entity\\Quiz' . "\0" . 'name', '' . "\0" . 'Domain\\Entity\\Quiz' . "\0" . 'description', '' . "\0" . 'Domain\\Entity\\Quiz' . "\0" . 'questions', '' . "\0" . 'Domain\\Entity\\Quiz' . "\0" . 'createdAt');
        }
