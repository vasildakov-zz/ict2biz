 ...
 */
class Answer extends \Domain\Entity\Answer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Domain\\Entity\\Answer' . "\0" . 'id', '' . "\0" . 'Domain\\Entity\\Answer' . "\0" . 'question', '' . "\0" . 'Domain\\Entity\\Answer' . "\0" . 'isCorrect');
        }
    ...
    public function isCorrect()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCorrect', array());
