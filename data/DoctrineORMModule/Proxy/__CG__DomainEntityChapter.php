 ...
 */
class Chapter extends \Domain\Entity\Chapter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Domain\\Entity\\Chapter' . "\0" . 'id', '' . "\0" . 'Domain\\Entity\\Chapter' . "\0" . 'book', '' . "\0" . 'Domain\\Entity\\Chapter' . "\0" . 'title', '' . "\0" . 'Domain\\Entity\\Chapter' . "\0" . 'pages');
        }
